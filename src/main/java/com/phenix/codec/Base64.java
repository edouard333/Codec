 ...
 * using very small files (~{@code <} 40 bytes).</li> <li>v2. 2 - Added some
 * helper methods for encoding/decoding directly from one file to the next. Also
 * added a main() method to support command line encoding/decoding from one file
...
public class Base64 {
     ...
     * {@code java.io.OutputStream}, given in the constructor, and encode/decode
     * to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3
